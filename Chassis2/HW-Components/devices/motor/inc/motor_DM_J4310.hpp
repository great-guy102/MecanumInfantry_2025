...
#ifndef HW_COMPONENTS_DEVICES_MOTOR_MOTOR_DM_J4310_HPP_
#define HW_COMPONENTS_DEVICES_MOTOR_MOTOR_DM_J4310_HPP_
...
class DM_J4310 : public Motor
{
 public:
  ...
  DM_J4310(DM_J4310&& other);
  DM_J4310& operator=(DM_J4310&& other);

  virtual ~DM_J4310(void) = default;
   ...
   *               为：
   *   @arg        DM_J4310::Cmd::kCmdEnable: 使能电机
   *   @arg        DM_J4310::Cmd::kCmdDisable: 失能电机
   *   @arg        DM_J4310::Cmd::kCmdClearErr: 清除错误
   * @retval       设置状态，可能的返回值有：
   *   @arg        Status::kOk: 设定成功
...
#endif /* HW_COMPONENTS_DEVICES_MOTOR_MOTOR_DM_J4310_HPP_ */
