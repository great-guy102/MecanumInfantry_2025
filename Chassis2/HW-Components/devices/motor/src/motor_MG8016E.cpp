/**
 *******************************************************************************
 * @file      : motor_MG8016E.cpp
 * @brief     : 瓴控 MG8016E 电机类
 * @history   :
...
MG8016E::MG8016E(uint8_t id, const OptionalParams& opt)
...
MG8016E& MG8016E::operator=(const MG8016E& other)
{
  if (this != &other) {
...
MG8016E::MG8016E(MG8016E&& other) : Motor(std::move(other))
{
  temp_ = other.temp_;
}

MG8016E& MG8016E::operator=(MG8016E&& other)
{
  if (this != &other) {
...
bool MG8016E::decode(size_t len, const uint8_t* data)
{
  /* 变量检查 */
#pragma region
...
bool MG8016E::encode(size_t& len, uint8_t* data)
{
  /* 变量检查 */
#pragma region
  HW_ASSERT(data, "data is nullptr");
...
void MG8016E::init(uint8_t id, const OptionalParams& opt)
{
  /* 变量检查 */
#pragma region
  HW_ASSERT(1 <= id && id <= 4, "Error id: %d", id);
