...
#ifndef HW_COMPONENTS_DEVICES_MOTOR_MOTOR_MF9025V2_HPP_
#define HW_COMPONENTS_DEVICES_MOTOR_MOTOR_MF9025V2_HPP_
...
class MF9025v2 : public Motor
{
 public:
  ...
  MF9025v2& operator=(const MF9025v2& other);
  MF9025v2(MF9025v2&& other);
  MF9025v2& operator=(MF9025v2&& other);
  ...
  /**
   * @brief       MF9025v2 初始化，使用默认构造函数后请务必调用此函数
   * @param        id: 电机 ID，1~4
   * @param        opt: 电机可选配置参数
   * @retval       None
   * @note        None
...
#endif /* HW_COMPONENTS_DEVICES_MOTOR_MOTOR_MF9025V2_HPP_ */
