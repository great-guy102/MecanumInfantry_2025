...
MF9025v2::MF9025v2(uint8_t id, const OptionalParams& opt)
...
MF9025v2& MF9025v2::operator=(const MF9025v2& other)
{
  if (this != &other) {
...
MF9025v2::MF9025v2(MF9025v2&& other) : Motor(std::move(other))
{
  temp_ = other.temp_;
}

MF9025v2& MF9025v2::operator=(MF9025v2&& other)
{
  if (this != &other) {
...
bool MF9025v2::decode(size_t len, const uint8_t* data)
{
  /* 变量检查 */
#pragma region
...
bool MF9025v2::encode(size_t& len, uint8_t* data)
{
  /* 变量检查 */
#pragma region
  HW_ASSERT(data, "data is nullptr");
...
void MF9025v2::init(uint8_t id, const OptionalParams& opt)
{
  /* 变量检查 */
#pragma region
  HW_ASSERT(1 <= id && id <= 4, "Error id: %d", id);
