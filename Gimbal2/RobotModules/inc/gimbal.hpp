...
private:
  ...
  // 控制电机的 PID 所需数据
  CtrlAngBased ctrl_ang_based_[kJointNum] = {
      CtrlAngBased::Motor, CtrlAngBased::Imu}; ///< 角度控制方式
  CtrlAngBased last_ctrl_ang_based_[kJointNum] = {
  ...
  float joint_tor_forward_[kJointNum] = {0.36f, 0.0f}; ///< 关节前馈力矩
